...
BYTE_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     */
    if (IS_BINARY_CONT(npy_byte, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_byte * a = (npy_byte *)args[0], * b = (npy_byte *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_byte, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_byte a = *(npy_byte *)args[0];
        npy_byte * b = (npy_byte *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
...
UBYTE_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     * vectorization is too tedious to be worthwhile
     */
    if (IS_BINARY_CONT(npy_ubyte, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_ubyte * a = (npy_ubyte *)args[0], * b = (npy_ubyte *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_ubyte, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_ubyte a = *(npy_ubyte *)args[0];
        npy_ubyte * b = (npy_ubyte *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
...
SHORT_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     * vectorization is too tedious to be worthwhile
     */
    if (IS_BINARY_CONT(npy_short, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_short * a = (npy_short *)args[0], * b = (npy_short *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_short, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_short a = *(npy_short *)args[0];
        npy_short * b = (npy_short *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
...
USHORT_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     * vectorization is too tedious to be worthwhile
     */
    if (IS_BINARY_CONT(npy_ushort, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_ushort * a = (npy_ushort *)args[0], * b = (npy_ushort *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_ushort, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_ushort a = *(npy_ushort *)args[0];
        npy_ushort * b = (npy_ushort *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
...
INT_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     * vectorization is too tedious to be worthwhile
     */
    if (IS_BINARY_CONT(npy_int, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_int * a = (npy_int *)args[0], * b = (npy_int *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_int, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_int a = *(npy_int *)args[0];
        npy_int * b = (npy_int *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
...
UINT_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     * vectorization is too tedious to be worthwhile
     */
    if (IS_BINARY_CONT(npy_uint, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_uint * a = (npy_uint *)args[0], * b = (npy_uint *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_uint, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_uint a = *(npy_uint *)args[0];
        npy_uint * b = (npy_uint *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
...
LONG_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     * vectorization is too tedious to be worthwhile
     */
    if (IS_BINARY_CONT(npy_long, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_long * a = (npy_long *)args[0], * b = (npy_long *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_long, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_long a = *(npy_long *)args[0];
        npy_long * b = (npy_long *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
    }
    else if (IS_BINARY_CONT_S2(npy_long, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_long * a = (npy_long *)args[0];
        npy_long b = *(npy_long*)args[1];
        npy_bool * o = (npy_bool *)args[2];
...
ULONG_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     * vectorization is too tedious to be worthwhile
     */
    if (IS_BINARY_CONT(npy_ulong, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_ulong * a = (npy_ulong *)args[0], * b = (npy_ulong *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_ulong, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_ulong a = *(npy_ulong *)args[0];
        npy_ulong * b = (npy_ulong *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
    }
    else if (IS_BINARY_CONT_S2(npy_ulong, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_ulong * a = (npy_ulong *)args[0];
        npy_ulong b = *(npy_ulong*)args[1];
        npy_bool * o = (npy_bool *)args[2];
...
LONGLONG_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     * vectorization is too tedious to be worthwhile
     */
    if (IS_BINARY_CONT(npy_longlong, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_longlong * a = (npy_longlong *)args[0], * b = (npy_longlong *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_longlong, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_longlong a = *(npy_longlong *)args[0];
        npy_longlong * b = (npy_longlong *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
...
ULONGLONG_equal(char **args, npy_intp *dimensions, npy_intp *steps, void *NPY_UNUSED(func))
{
     ...
     * vectorization is too tedious to be worthwhile
     */
    if (IS_BINARY_CONT(npy_ulonglong, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_ulonglong * a = (npy_ulonglong *)args[0], * b = (npy_ulonglong *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a[i] == b[i];
        }
    }
    else if (IS_BINARY_CONT_S1(npy_ulonglong, npy_bool)) {
        npy_intp i, n = dimensions[0];
        npy_ulonglong a = *(npy_ulonglong *)args[0];
        npy_ulonglong * b = (npy_ulonglong *)args[1];
        npy_bool * o = (npy_bool *)args[2];
        for (i = 0; i < n; i++) {
            o[i] = a == b[i];
        }
